...
Public Class apiStudent
    ...
    <WebMethod()> _
    Public Shared Function P_Student_IU(St_ID As Integer, St_Name As String, St_DOB As Date, ST_Gender As String, Class_ID As Integer) As Integer
        Return StudentDataProvider.P_Student_IU(New StudentInfo(St_ID, St_Name, St_DOB, ST_Gender, Class_ID))
    End Function
